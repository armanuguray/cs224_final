...
public:
    WaveParticle();
    WaveParticle(const Vector2& position, const Vector2& velocity, REAL amplitude, const Vector2& dispersionOrigin, REAL dispersionAngle);
    WaveParticle(REAL amplitude, const Vector2& dispersionOrigin, REAL dispersionAngle, REAL movementAngle);
    ~WaveParticle();

    void spawn(const Vector2& position, const Vector2& velocity, REAL amplitude, const Vector2& dispersionOrigin, REAL dispersionAngle);
    void spawn(REAL amplitude, const Vector2& dispersionOrigin, REAL dispersionAngle, REAL movementAngle);
